      ...
      <div>
        <Grid>
          <Cell col={4}>
            ...
            <hr style={{borderTop: '3px solid #327580', width: '50%'}}/>
          ...
          <Cell className="resume-right-col" col={8}>
              ...
              schoolDescription="Junior level status with courses completed in multiple disciplines. Currently on a hiatus from GVSU due to extenuating circumstances and the Covid-19 virus."
               ...
               <Education
                 ...
                 schoolDescription="Completed the Full Stack Web Development curriculumn with Computer Science fundamentals. Over 1,300 hours."
                  />
                <hr style={{borderTop: '3px solid #327580'}} />
            ...
            <Experience
              ...
              jobDescription="Worked with the CEO of Miracle Messages, a nonprofit organization that helps the homeless. I worked with a team of 4 other web developers to create a beautiful website with interactive map and much more using the SERN stack over the course of a couple months."
              />
